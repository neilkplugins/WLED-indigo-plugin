...
class Plugin(indigo.PluginBase):
    ...
    def update(self,device):
        ...
        # Thanks to Joel for the suggestion on the optimisation to update the device states in a single call
        theKey = []
        theKey.append({ 'key' : "WLEDversion", 'value' : statusjson['info']['ver']})
        ...
        theKey.append({ 'key' : "effect", 'value' : statusjson['state']['seg'][0]['fx']})
        #device.updateStateOnServer("effectname", wledeffects[statusjson['state']['seg'][0]['fx']])
        theKey.append({ 'key' : "effectname", 'value' : wledeffects[statusjson['state']['seg'][0]['fx']]})
        #device.updateStateOnServer("effectintensity", statusjson['state']['seg'][0]['ix'])
        theKey.append({ 'key' : "effectintensity", 'value' : statusjson['state']['seg'][0]['ix']})
        #device.updateStateOnServer("effectspeed", statusjson['state']['seg'][0]['sx'])
        theKey.append({ 'key' : "effectspeed", 'value' : statusjson['state']['seg'][0]['sx']})
        #device.updateStateOnServer("nightlight", statusjson['state']['nl']['on'])
        theKey.append({ 'key' : "nightlight", 'value' : statusjson['state']['nl']['on']})
        #device.updateStateOnServer("nightlightduration", statusjson['state']['nl']['dur'])
        theKey.append({ 'key' : "nightlightduration", 'value' : statusjson['state']['nl']['dur']})
        #device.updateStateOnServer("primarybluevalue", statusjson['state']['seg'][0]['col'][0][2])
        theKey.append({ 'key' : "primarybluevalue", 'value' : statusjson['state']['seg'][0]['col'][0][2]})
        #device.updateStateOnServer("primaryredvalue", statusjson['state']['seg'][0]['col'][0][0])
        theKey.append({ 'key' : "primaryredvalue", 'value' : statusjson['state']['seg'][0]['col'][0][0]})
        #device.updateStateOnServer("primarygreenvalue", statusjson['state']['seg'][0]['col'][0][1])
        theKey.append({ 'key' : "primarygreenvalue", 'value' : statusjson['state']['seg'][0]['col'][0][1]})
        #device.updateStateOnServer("secondarybluevalue", statusjson['state']['seg'][0]['col'][1][2])
        theKey.append({ 'key' : "secondarybluevalue", 'value' : statusjson['state']['seg'][0]['col'][1][2]})
        #device.updateStateOnServer("secondaryredvalue", statusjson['state']['seg'][0]['col'][1][0])
        theKey.append({ 'key' : "secondaryredvalue", 'value' : statusjson['state']['seg'][0]['col'][1][0]})
        #device.updateStateOnServer("secondarygreenvalue", statusjson['state']['seg'][0]['col'][1][1])
        theKey.append({ 'key' : "secondarygreenvalue", 'value' : statusjson['state']['seg'][0]['col'][1][1]})
        #device.updateStateOnServer("UDPsend", statusjson['state']['udpn']['send'])
        theKey.append({ 'key' : "UDPsend", 'value' : statusjson['state']['udpn']['send']})
        #device.updateStateOnServer("UDPrecv", statusjson['state']['udpn']['recv'])
        theKey.append({ 'key' : "UDPrecv", 'value' : statusjson['state']['udpn']['recv']})
        # Now update in one go
        device.updateStatesOnServer(theKey)
